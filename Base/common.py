...
if PROJ_INIT:
    ...
    QITIAN_APP_ID = QITIAN_APP_SECRET = QITIAN_HOST = None
    SECRET_KEY = JWT_ENCODE_ALGO = None

    HOST = ADMIN_QITIAN = None
else:
    QITIAN_APP_ID = Config.get_value_by_key(CI.QITIAN_APP_ID)
    QITIAN_APP_SECRET = Config.get_value_by_key(CI.QITIAN_APP_SECRET)
    QITIAN_HOST = Config.get_value_by_key(CI.QITIAN_HOST)
